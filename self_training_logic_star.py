...
def main():
    ...
    for cur_iter in range(0,args.iter_num):
        ...
        subprocess.call(["python", f"/cpfs01/user/xufangzhi/symbol-llm-v2/self-training/organize_preference_data_logic_star_{base_model}.py", \
