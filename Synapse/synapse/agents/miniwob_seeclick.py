...
class Agent:
    def __init__(self, args):
        self.args = args
        self.env = MiniWoBEnv(args=args, subdomain=args.env_name, headless=args.headless)
    ...
    def reset(self, seed: int) -> None:
        self.state = self.env.reset(seed=seed, record_screenshots=False)
    ...
    def step(self, action):
        ...
        miniwob_step = {"html": self.state, "screenshot": miniwob_sceenshot, "action": action_record, "goal": goal}
