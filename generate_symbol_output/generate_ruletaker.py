...
from prompt import math_prompt, theoremqa_prompt, proofwriter_prompt

# PATH_TO_CONVERTED_WEIGHTS = "/cpfs01/user/xufangzhi/symbol-llm-v2/open-instruct/output/proofwriter_claude2_sft_tune_llama2chat_13B"
...
PATH_TO_CONVERTED_WEIGHTS = "/cpfs01/user/xufangzhi/symbol-llm-v2/open-instruct/output/logic_v17_deepseekchat_sft_iter7_sft_tune_deepseekchat_7B"
...
for beam in [2]:
    ...
    # model_folder = f"llama3chat_8b_fs_beam{beam}"
    # model_folder = f"proofwriter_claude2_sft_tune_llama2chat_13b_beam{beam}"
    model_folder = f"logic_v17_deepseekchat_sft_iter7_sft_tune_deepseekchat_7b_beam{beam}"

    for dataset in ['ruletaker']:

        test_path = f"symbol-llm-v2/test_dataset/{dataset}/test.json"
